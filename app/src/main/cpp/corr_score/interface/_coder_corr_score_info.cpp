...
//
// _coder_corr_score_info.cpp
//
// Code generation for function 'corr_score'
//

// Include files
#include "_coder_corr_score_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("corr_score"));
  ...
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739740.98354166665));
...
// End of code generation (_coder_corr_score_info.cpp)
